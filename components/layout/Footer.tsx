      ...
      <div className="w-full px-4 mx-auto">
            ...
            <div className="flex flex-wrap mb-6 items-top">
              <div className="w-full px-4 ml-auto lg:w-4/12">
                ...
                <ul className="list-unstyled">
                  <li>
                    <Link className="block pb-2 text-sm font-semibold text-blueGray-600 hover:text-blueGray-800" href="https://www.creative-tim.com/presentation?ref=njs-profile">About Us</Link>
                  </li>
              ...
              <div className="w-full px-4 lg:w-4/12">
                ...
                <ul className="list-unstyled">
                  <li>
                    <Link className="block pb-2 text-sm font-semibold text-blueGray-600 hover:text-blueGray-800" href="https://github.com/creativetimofficial/notus-js/blob/main/LICENSE.md?ref=njs-profile">MIT License</Link>
                  </li>
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-between">
          <div className="w-full px-4 mx-auto text-center md:w-4/12">
            <div className="py-1  text-blueGray-500 group">
              Copyright © <span>2024</span><Link href="/" className="text-blueGray-500 hover:text-gray-800" target="_blank"> Created by </Link>
              <Link href="" className="text-blueGray-500 hover:text-blueGray-800 group:hover-underline">Black Rabbit Studio</Link>.
            </div>
          </div>
        </div>
      </div>
